...
const OrnamentalDivider: React.FC<OrnamentalDividerProps> = ({
  ...
  if (variant === "horizontal") {
    return (
      <div className={`flex items-center justify-center ${className}`}>
        <div
          className={`${horizontalSizeClasses[size]} bg-gradient-to-r from-transparent via-ayur-gold to-transparent relative`}
        >
          {/* Decorative elements */}
  ...
  return (
    <div className={`flex flex-col items-center justify-center ${className}`}>
      <div
        className={`${sizeClasses[size]} bg-gradient-to-b from-transparent via-ayur-gold to-transparent relative`}
      >
