...
const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <div className="bg-white text-black py-8 mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-times text-4xl md:text-5xl font-bold">
            Privacy Policy
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="prose prose-lg max-w-none">
          <div className="bg-white py-8">
            <h2 className="font-times text-2xl font-bold text-black mb-6">
              Sukh Sancharak Co. Privacy Policy
            </h2>

            <div className="space-y-8">
              <section>
                <h3 className="font-times text-xl font-semibold text-black mb-4">
                  SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?
                </h3>
                <div className="font-lora text-black space-y-4">
                  <p>
                  ...
                  <p>
                    ...
                    may send you emails about our store, new products and other
                    updates.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="font-lora text-black space-y-4">
                  <h4 className="font-times text-lg font-semibold text-black mb-3">
                  ...
                  <h4 className="font-times text-lg font-semibold text-black mb-3 mt-6">
                  ...
                  <p>
                    ...
                    anytime, by contacting us at sukhsancharak1890@gmail.com or
                    mailing us at: Sukh Sancharak Co., Chatta Bazar, Holi Gate,
                    Mathura – 281001.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="font-lora text-black space-y-4">
                  <p>
                    ...
                    Privacy Compliance Officer at sukhsancharak1890@gmail.com or
                    by mail at Sukh Sancharak Co., Chatta Bazar, Holi Gate,
                    Mathura – 281001.
                  </p>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg mt-6">
                    ...
                    <p className="text-black">
                      [2nd floor, Upstairs of central bank building, Tilak Dwar,
                      Mathura - 281001]
                    </p>
                  </div>
                </div>
